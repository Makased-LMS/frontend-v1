...
function CreateQuizDialog({ payload, open, onClose }) {
  ...
  useEffect(() => {
    setTotalMarks(() =>
      questionsDraft?.reduce((sum, cur) => (sum += cur.points), 0)
    );
  ...
  const handleAddQuiz = async (data) => {
    if (payload.data?.id) return handleEditQuiz(data);
  ...
  return (
    ...
    >
      <Grid
        ...
        padding={2}
      >
        <Button sx={{ visibility: "hidden" }}>Add questions</Button>
        ...
        >
          ...
          <TextField
            ...
            {...register("durationMinutes", {
              ...
              min: {
                value: 1,
                message: "Number of minutes should be more than 0",
              },
            })}
          />
          ...
          <TextField
            ...
            {...register("passThresholdPoints", {
              ...
              max: {
                value: totalMarks,
                message: "Pass mark shouldn't be greater than Total Marks",
              },
            })}
          />
          <TextField
      ...
      <DialogActions>
        ...
        <LoadingButton
          type="submit"
          variant="outlined"
          loading={isLoading || dispatchingCourse}
          disabled={isLoading || dispatchingCourse}
          loadingPosition="end"
          endIcon={<Save />}
        >
